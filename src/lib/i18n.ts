...
const zhCN: Dict = {
  ...
  "voice.done": "已插入文字",
  "voice.error": "转写失败，请稍后重试。",
  "voice.noSpeech": "未检测到有效语音，请靠近麦克风后重试。",
  "voice.packNotReady": "语音模型未就绪，请先在设置中下载。",
  ...
  "settings.defaultSaveDirectoryHint": "未保存文件第一次保存时，“另存为”默认打开到此目录。未自定义时使用系统「文档」文件夹。",
  "settings.chooseDirectory": "选择目录…",
  "settings.clearDirectory": "清除",
  "settings.resetDirectory": "恢复默认",
  "settings.notSet": "未设置",
  "settings.systemDocuments": "系统默认（文档）",
  ...
  "settings.shellNewOn": "已添加「新建文本文件」到右键菜单",
  "settings.shellNewOff": "已从右键菜单移除「新建文本文件」",
  "settings.shellOpenOn": "已添加「用 Jotpad 打开」到右键菜单",
  "settings.shellOpenOff": "已从右键菜单移除「用 Jotpad 打开」",
  ...
  "update.readyTitle": "v{version} 已就绪",
  "update.readyBody": "新版本已下载完成，重启即可更新。",
  "update.skippedHint": "你曾跳过此版本。仍可立即更新。",
  "update.linuxManualHint": "当前安装方式不支持应用内升级，请从发布页下载安装包（推荐 AppImage 以启用后续自动更新）。",
  "update.downloadingTitle": "正在下载 v{version}",
  "update.downloading": "正在下载…",
  "update.downloadingPct": "正在下载… {pct}%",
  "update.installingTitle": "正在安装 v{version}",
  "update.installing": "即将重启以完成更新…",
  "update.install": "立即重启更新",
  "update.skip": "跳过此版本",
  ...
  "settings.localHistory": "保存时记录本地历史",
  "history.menu": "本地历史…",
  "history.title": "本地历史",
  "history.needSavedFile": "未关联文件",
  "history.needSavedFileHint": "请先保存文件后再查看本地历史。",
  "history.loading": "加载中…",
  "history.empty": "暂无历史快照。保存文件后会自动记录。",
  "history.compareDisk": "查看差异（缓冲 vs 磁盘）",
  "history.compareCurrent": "与当前对比",
  "history.compareEntryDisk": "与磁盘对比",
  "history.restore": "恢复此版本",
  "history.delete": "删除",
  "history.clear": "清空历史",
  "history.restoreConfirm": "用所选快照替换当前编辑内容？未保存的更改将丢失。",
  "history.clearConfirm": "清空此文件的全部本地历史？",
  "history.pickEntry": "选择左侧一条快照以对比或恢复。",
  "history.currentBuffer": "当前缓冲",
  "history.diskVersion": "磁盘版本",
};
...
const en: Dict = {
  ...
  "voice.done": "Inserted",
  "voice.error": "Transcription failed. Please try again.",
  "voice.noSpeech": "No speech detected. Move closer to the mic and try again.",
  "voice.packNotReady": "Voice model not ready. Download it in Settings first.",
  ...
  "settings.defaultSaveDirectoryHint": "Save As opens here for untitled files. When unset, uses the system Documents folder.",
  "settings.chooseDirectory": "Choose Folder…",
  "settings.clearDirectory": "Clear",
  "settings.resetDirectory": "Reset to Default",
  "settings.notSet": "Not set",
  "settings.systemDocuments": "System default (Documents)",
  ...
  "settings.shellNewOn": "“New Text File” added to context menu",
  "settings.shellNewOff": "“New Text File” removed from context menu",
  "settings.shellOpenOn": "“Open with Jotpad” added to context menu",
  "settings.shellOpenOff": "“Open with Jotpad” removed from context menu",
  ...
  "update.readyTitle": "v{version} is ready",
  "update.readyBody": "The update has been downloaded. Restart to install.",
  ...
  "update.installingTitle": "Installing v{version}",
  "update.installing": "The app will restart to finish updating…",
  ...
  "settings.localHistory": "Keep local history on save",
  "history.menu": "Local History…",
  "history.title": "Local History",
  "history.needSavedFile": "No file path",
  "history.needSavedFileHint": "Save the file first to view local history.",
  "history.loading": "Loading…",
  "history.empty": "No snapshots yet. They appear after you save.",
  "history.compareDisk": "View Diff (Buffer vs Disk)",
  "history.compareCurrent": "Compare with Current",
  "history.compareEntryDisk": "Compare with Disk",
  "history.restore": "Restore",
  "history.delete": "Delete",
  "history.clear": "Clear History",
  "history.restoreConfirm": "Replace the current buffer with this snapshot? Unsaved changes will be lost.",
  "history.clearConfirm": "Clear all local history for this file?",
  "history.pickEntry": "Select a snapshot to compare or restore.",
  "history.currentBuffer": "Current buffer",
  "history.diskVersion": "On disk",
};
